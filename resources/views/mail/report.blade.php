                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <p>
                            <b>{{ $report->client->representative->default_name }}</b>, здравствуйте!
                        </p>
                        <p>
                            Преподаватель по
                            ...
                            <tr>
                              <td align="center">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="{{ config('app.url') }}" target="_blank">Просмотреть отчёт в личном кабинете</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">С уважинием, ЕГЭ-Центр</span>
                  </td>
                </tr>
                 <tr>
