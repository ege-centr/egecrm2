...
<p>
    ...
    @name($contract->client->names->full, 'родительный'), ###### года рождения, именуемого(ой)
...
<p>11.4. Вся переписка между Сторонами, в том числе обязательные документы, связанные с исполнением настоящего Договора, направляются путем использования почты, электронной почты, курьерскими службами и/или иными, установленными законом способами. Корреспонденция считается полученной, если она была направлена:
	<ul>
