...
<p><b>2.1. Исполнитель обязуется:</b></p>
	...
	<ul style="margin: 0">
        ...
        <li>Логин: email Заказчика, указанный при заключении Договора ({{ representative.email || 'email отсутствует' }})</li>
	...
	<ul style="margin: 0">
		<li>Адрес: https://lk.ege-centr.ru</li>
        <li>Логин: email Обучающегося, указанный при заключении Договора ({{ student.email || 'email отсутствует' }})</li>
