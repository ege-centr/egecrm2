...
<div style="display: inline-block; width: 100%; margin-bottom: 20px">
    ...
    <span style="float: right">{{ $contractDate }} г.</span>
</div>
...
<p>
    ...
    @name($contract->client->names->full, 'родительный'), {{ date('Y', strtotime($contract->client->birthdate)) }} года рождения, именуемого(ой)
...
<p>
    ...
    @foreach($contract->subjects as $subject)
        ...
        (@plural(ceil($subject->lessons_planned * 3), 'аудиторный час') и
...
<p>1.5. Вид образования: дополнительное образование детей и взрослых, продолжительность обучения:
    {{ collect($contract->subjects)->max('lessons_planned') }} учебных недель.
</p>
...
<li>по инициативе Заказчика при условии письменного уведомления второй Стороны не позднее, чем за 10 (десять) рабочих дней; <br>по инициативе Исполнителя при условии уведомления второй Стороны не позднее, чем за 5 (пять) рабочих дней;</li>
