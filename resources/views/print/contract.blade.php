   ...
   <h4 style="margin-bottom: 0" class="ng-binding">Договор №{{ $contract->number }}</h4>
   <h4 style="margin-top: 0">на оказание платных образовательных услуг</h4>
   <div style="display: inline-block; width: 100%; margin-bottom: 20px"><span style="float: left">г. Москва</span> <span style="float: right" class="ng-binding">07.09.18 г.</span></div>
   <p class="ng-binding"><b>Общество с ограниченной ответственностью «ЕГЭ-ЦЕНТР»</b>, в лице Генерального директора Эрдмана Константина Александровича, действующего на основании Устава, именуемое в дальнейшем «Исполнитель», «ЕГЭ-Центр», на основании лицензии на осуществление образовательной деятельности № 037742, выданной Департаментом образования города Москвы 08.08.2016 г., с одной стороны, и Белоусова Наталия Павловна, именуемый(ая) в дальнейшем «Заказчик», являющийся(щаяся) родителем (законным представителем) Белоусова Даниила Геннадьевича, 31.01.01 года рождения, именуемого(ой) в дальнейшем «Обучающийся», с другой стороны, совместно именуемые «Стороны», заключили настоящий Договор на оказание платных образовательных услуг (далее – «Договор») о нижеследующем:</p>
   <h4>1. Предмет Договора.</h4>
   <p>
      1.1. По настоящему Договору Исполнитель обязуется зачислить Обучающегося на обучение и оказать Обучающемуся образовательные услуги по программе дополнительного обучения по курсу (курсам): <!--{cke_protected}{C}%3C!%2D%2D%20ngRepeat%3A%20subject%20in%20getSubjects(contract)%20%2D%2D%3E-->
      <span ng-repeat="subject in getSubjects(contract)" class="ng-binding ng-scope ng-animate">
         «Информатика» (33
         <ng-pluralize count="subject.count" when="{
            'one' 	: 'занятие',
            'few'	: 'занятия',
            'many'	: 'занятий',
            }">занятия</ng-pluralize>
         )
      </span>
   </p>
   <p>1.2. Обучение осуществляется в порядке, установленном локальными нормативными актами Исполнителя и настоящим Договором.</p>
   <p>
      1.3. Продолжительность образовательной программы по программе курса <!--{cke_protected}{C}%3C!%2D%2D%20ngRepeat%3A%20subject%20in%20getSubjects(contract)%20%2D%2D%3E-->
      <span ng-repeat="subject in getSubjects(contract)" class="ng-binding ng-scope ng-animate">
         «Информатика-11-33» (99 аудиторных
         <ng-pluralize count="ceil(subject.count_program * 3)" when="{'one' : 'час', 'few' : 'часа', 'many' : 'часов'}">часов</ng-pluralize>
         и 50
         <ng-pluralize count="ceil(subject.count_program * 1.5)" when="{'one' : 'час', 'few' : 'часа', 'many' : 'часов'}">часов</ng-pluralize>
         на самостоятельную подготовку).
      </span>
      <!--{cke_protected}{C}%3C!%2D%2D%20end%20ngRepeat%3A%20subject%20in%20getSubjects(contract)%20%2D%2D%3E--> Форма обучения – очная.
   </p>
   <p>1.4. Место оказания Услуг по Договору: г. Москва, ул. Мясницкая, дом 40, стр. 1, 3 этаж.</p>
   <p class="ng-binding">
      1.5. Вид образования: дополнительное образование детей и взрослых, продолжительность обучения: 33
      <ng-pluralize count="getMaxSubjectCount(contract)" when="{
         'one' 	: 'учебная неделя',
         'few'	: 'учебных недели',
         'many'	: 'учебных недель',
         }">учебных недели</ng-pluralize>
      .
   </p>
   <h4>2. Права и обязанности Сторон.</h4>
   <p><b>2.1. Исполнитель обязуется:</b></p>
   <p>2.1.1. Предоставить Заказчику и Обучающемуся доступ к личному кабинету. Данные для доступа в личный кабинет Заказчика:</p>
   <ul style="margin: 0">
      <li>Адрес: https://lk.ege-centr.ru</li>
      <li class="ng-binding">Логин: email Заказчика, указанный при заключении Договора (puschka0880@yandex.ru)</li>
      <li>Пароль: назначается Заказчиком (представителем) самостоятельно при первом входе в личный кабинет</li>
   </ul>
   <p>Данные для доступа в личный кабинет Обучающегося:</p>
   <ul style="margin: 0">
      <li>Адрес: https://lk.ege-centr.ru</li>
      <li class="ng-binding">Логин: email Обучающегося, указанный при заключении Договора (danila.belousoff@yandex.ru)</li>
      <li>Пароль: назначается Обучающимся (учеником) самостоятельно при первом входе в личный кабинет</li>
   </ul>
   ...
   <p>2.1.9. По окончании обучения по письменному заявлению Заказчика выдать справку о прохождении соответствующих образовательных программ с указанием даты начала занятий.</p>
   ...
   <p>2.2.7. Если Обучающийся представляет непосредственную опасность для себя, других Обучающихся, преподавателей, сотрудников, Исполнитель имеет право приостановить исполнение Договора немедленно, с уведомлением Заказчика в течение 1 (Одного) рабочего дня с момента возникновения вышеуказанных обстоятельств. Стоимость пропущенных занятий при этом не компенсируется. В том числе, но, не ограничиваясь, при поступлении информации о заразной болезни Обучающегося, которая может препятствовать образовательному процессу для других обучающихся – не допускать такого Обучающегося до занятий, а также, требовать справки об окончании болезни Обучающегося. При этом стоимость пропущенных по причине болезни занятий не возмещается.</p>
   ...
   <p>2.4.8. Бережно относиться к имуществу Исполнителя, возмещать ущерб, причиненный Обучающимся имуществу Исполнителя, в соответствии с законодательством Российской Федерации. Утрата имущества Исполнителя подлежит возмещению со стороны Заказчика в случае причинения материального ущерба на сумму более 1000 (одна тысяча) руб.</p>
   ...
   <p class="ng-binding">
      3.1. Общая стоимость Услуг Исполнителя по Договору складывается из стоимости 33
      <ng-pluralize count="subjectCount(contract)" when="{
         'one'	: 'занятия',
         'few'	: 'занятий',
         'many'	: 'занятий',
         }">занятий</ng-pluralize>
      , приобретаемых на момент заключения Договора, и <span ng-show="contract.discount > 0" class="ng-binding ng-hide">с учетом скидки 0%</span> составляет 62&nbsp;700 (<span class="m_title ng-binding">шестьдесят два тысячи семьсот</span>) руб.
   </p>
   <p>3.2. <span ng-show="!(contract.discount > 0)" class="ng-binding">Стоимость одного занятия составляет 1900 руб.</span> <span ng-show="contract.discount > 0" class="ng-binding ng-hide">Стоимость одного занятия с учетом скидки 0% составляет 1900 руб.</span></p>
   ...
   <p>3.4. Оплата Услуг по настоящему Договору <span ng-show="contract.discount > 0" class="ng-binding ng-hide">с учетом скидки 0%</span> производится Заказчиком следующим образом:</p>
   <ul style="margin: 0">
      <!--{cke_protected}{C}%3C!%2D%2D%20ngRepeat%3A%20payment%20in%20contract.payments%20%2D%2D%3E-->
      <li ng-repeat="payment in contract.payments" class="ng-binding ng-scope ng-animate">
         платеж в размере 20&nbsp;900 руб. (11
         <ng-pluralize count="payment.lesson_count" when="{
            'one' 	: 'занятие',
            'few'	: 'занятия',
            'many'	: 'занятий',
            }">занятий</ng-pluralize>
         ) производится <!--{cke_protected}{C}%3C!%2D%2D%20ngIf%3A%20!%24index%20%2D%2D%3E--><span ng-if="!$index" class="ng-scope"> при заключении Договора</span><!--{cke_protected}{C}%3C!%2D%2D%20end%20ngIf%3A%20!%24index%20%2D%2D%3E--> <!--{cke_protected}{C}%3C!%2D%2D%20ngIf%3A%20%24index%20%2D%2D%3E-->
      </li>
      <!--{cke_protected}{C}%3C!%2D%2D%20end%20ngRepeat%3A%20payment%20in%20contract.payments%20%2D%2D%3E-->
      <li ng-repeat="payment in contract.payments" class="ng-binding ng-scope ng-animate">
         платеж в размере 20&nbsp;900 руб. (11
         <ng-pluralize count="payment.lesson_count" when="{
            'one' 	: 'занятие',
         ...
         ) производится <!--{cke_protected}{C}%3C!%2D%2D%20ngIf%3A%20!%24index%20%2D%2D%3E--> <!--{cke_protected}{C}%3C!%2D%2D%20ngIf%3A%20%24index%20%2D%2D%3E--><span ng-if="$index" class="ng-binding ng-scope"> до 26.11.18 </span><!--{cke_protected}{C}%3C!%2D%2D%20end%20ngIf%3A%20%24index%20%2D%2D%3E-->
      </li>
      <!--{cke_protected}{C}%3C!%2D%2D%20end%20ngRepeat%3A%20payment%20in%20contract.payments%20%2D%2D%3E-->
      <li ng-repeat="payment in contract.payments" class="ng-binding ng-scope ng-animate">
         платеж в размере 20&nbsp;900 руб. (11
         ...
         ) производится <!--{cke_protected}{C}%3C!%2D%2D%20ngIf%3A%20!%24index%20%2D%2D%3E--> <!--{cke_protected}{C}%3C!%2D%2D%20ngIf%3A%20%24index%20%2D%2D%3E--><span ng-if="$index" class="ng-binding ng-scope"> до 25.02.19 </span><!--{cke_protected}{C}%3C!%2D%2D%20end%20ngIf%3A%20%24index%20%2D%2D%3E-->
      </li>
      <!--{cke_protected}{C}%3C!%2D%2D%20end%20ngRepeat%3A%20payment%20in%20contract.payments%20%2D%2D%3E-->
   </ul>
   ...
   <p>4.3.2. Заказчик дает согласие на видео и фотосъемку Обучающегося, организуемую Исполнителем в процессе обучения. Видео и фотосъемка производятся во время одного из занятий. Видео и фотосъемка могут продолжаться в течение не более чем одного академического часа. Исполнитель вправе в целях исполнения обязательств, предусмотренных настоящим Договором и законом запросить предоставление иных сведений или копии документов.</p>
   <p>4.4. Целью обработки персональных данных Заказчика и Обучающегося является исполнение Сторонами обязательств по настоящему Договору, в том числе, обеспечение организации учебного процесса, ведение бухгалтерского учета, сбор и обработка статистических данных, популяризация оказываемых Исполнителем образовательных услуг, контроль качества оказания услуг, выполнение требований законодательства Российской Федерации об образовании и пр. Исполнитель обязуется использовать полученные персональные данные Заказчика исключительно в заявленных целях в соответствии с действующим законодательством Российской Федерации. Исполнитель имеет право размещать переданные ему персональные данные на собственном сайте, в том числе, но, не ограничиваясь, для организации работы личного кабинета Обучающегося, организации системы контроля качества исполнения услуг.</p>
   ...
   <p>Согласие на обработку моих персональных данных и персональных данных Обучающегося предоставляю: ___________________________________________________________________</p>
   <p><br></p>
   <p><br></p>
   ...
   <p>Если Заказчик отказывается от исполнения Договора, то он обязан оплатить оказанные услуги (состоявшиеся&nbsp;занятия)&nbsp;к моменту отказа от Договора.</p>
   ...
   <p class="ng-binding">11.2. Настоящий Договор вступает в силу с даты, его подписания, заключен на срок до 01 июля 2019 года.</p>
   ...
   <div style="display: inline-block; width: 100%">
      <div style="width: 50%; float: left;"><b>ИСПОЛНИТЕЛЬ:</b><br>Общество с ограниченной ответственностью<br>«ЕГЭ-Центр»<br>ОГРН 1167746382319 от 15.04.2016<br>ИНН 9701038111<br>г. Москва, ул. Мясницкая, д. 40,<br>стр. 1, 3 эт., к. 7, 101000<br>Р/сч: 40702 810 8019 6000 0153<br>АО «Альфа-Банк»<br>к/сч 30101810200000000593, БИК 044525593<br>Тел.: +7(495)646 85 92<br>e-mail: info@ege-centr.ru</div>
      <div style="width: 50%; float: right;" class="ng-binding"><b>ЗАКАЗЧИК:</b><br>Белоусова Наталия Павловна<br>Паспорт 4510 номер 236148<br>Выдан: Отделением по р-ну Жулебино ОУФМС РФ по гор. Москве в ЮВАО, 11.08.09<br>Код подразделения: 770-101<br>Зарегистрирован по адресу: пр-т Лермонтовский, д. 8, корп. 1, 265<br>Факт. адрес: пр-т Лермонтовский, д. 8, корп. 1, 265<br>Тел.: 79164482946<br>e-mail: puschka0880@yandex.ru</div>
   </div>
   <div style="margin: 50px 0 0 0">
      <div style="display: inline-block; float: left; width: 50%">Генеральный директор ООО «ЕГЭ-Центр»<br>Эрдман К. А.</div>
      <div style="display: inline-block; width: 50%" class="ng-binding">Белоусова Н. П</div>
   </div>
   <div style="margin: 50px 0 0">
      <div style="display: inline-block; width: 50%">
         <div style="margin-top: 30px">____________________</div>
      </div>
      <div style="display: inline-block; width: 50%">
         <div style="margin-top: 30px">____________________</div>
      </div>
   ...
   <div style="page-break-before: always; position: relative">
      ...
      <div style="text-align: right" class="ng-binding">Приложение № 1<br>к Договору оказания платных<br>образовательных услуг<br>№9105 от 07.09.18</div>
      <h4 class="ng-binding">АКТ ОБ ОКАЗАННЫХ УСЛУГАХ<br>ПО ДОГОВОРУ №9105 от 07.09.18</h4>
      <div style="display: inline-block; width: 100%; margin-bottom: 20px"><span style="float: left">г. Москва</span> <span style="float: right">«____»_______ 20____ г.</span></div>
      Мы, нижеподписавшиеся:<br><br>От имени Заказчика: __________________, и от имени Исполнителя _______________________ ______________________, действующий (-ая) на основании ___________________, составили акт о том, что в соответствии с обязательствами, предусмотренными Договором от «___» ______ 20____ г. № ________ Исполнитель оказал Заказчику в полном объеме услуги на сумму: ______ (_______) руб. _____ копеек. НДС не облагается.<br><br>Заказчик претензий к Исполнителю не имеет.<br><br>Настоящий акт составлен в двух экземплярах, по одному для каждой Стороны.
      <div style="margin: 50px 0 0 0">
         <div style="display: inline-block; float: left; width: 50%">Генеральный директор ООО «ЕГЭ-Центр»<br>Эрдман К. А.</div>
         <div style="display: inline-block; width: 50%" class="ng-binding">Белоусова Н. П</div>
      </div>
