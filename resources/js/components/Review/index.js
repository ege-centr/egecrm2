...
export const FILTERS = [
  ...
  {label: 'Оценка ученика', field: 'client', type: 'multiple', options: [
  ...
  {label: 'Оценка админа предварительная', field: 'admin', type: 'multiple', options: [
    {id: -2, title: 'отсутствует'},
    {id: -1, title: '0'},
    {id: 1, title: '1'},
    {id: 2, title: '2'},
  ...
  {label: 'Оценка админа финал', field: 'final', type: 'multiple', options: [
    {id: -2, title: 'отсутствует'},
    {id: -1, title: '0'},
    {id: 1, title: '1'},
    {id: 2, title: '2'},
